...
// export function useProjImg(contractAddress: string): string | undefined {
//   const projImgReader = useCrowdfundingProjectFunctionReader({
//     contractAddress: contractAddress,
//     functionName: "projImg",
//   });

//   const projImg:
//     | Awaited<ReturnType<Crowdfundingproject["projTitle"]>>
//     | Result
//     | undefined = projImgReader.data;

//   DEBUG && console.log("projImg: ", projImg);

//   if (!projImg) return undefined;

//   return projImg as unknown as string;
// }
